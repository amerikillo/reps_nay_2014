...
<div class="container">
  ...
  <%
	...
	%>
    <div> <a href="venta_total.jsp">Reporte de Ventas</a> &gt; <a href="det_venta.jsp?tipo=<%=request.getParameter("tipo")%>">Tipo <%=tip%></a> &gt; <span class="banda">Jurisdiccion <%=juris%></span></div>
  </div>
  <div>
    <h2>Ventas Totales&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gnr_detalle_juris.jsp?juris=<%=request.getParameter("juris")%>&tipo=<%=request.getParameter("tipo")%>"><img src="../../imagen/Excel-2013.png" alt="Exportar a Excel" width="40" height="40" /></a></h2>
    <p>&nbsp;</p>
  </div>
    ...
    <div style="width:600; float:right; background-color:#FFF; padding:5px; font-family:Arial, Helvetica, sans-serif">
      ...
      <table width="690"  class="table table-bordered table-striped table-hover" style="font-size:10px;">
        ...
        <tr class="mun_uni">
          ...
          <td colspan="6"><div id="item<%=cont_mun%>" style="display:none" align="justify" >
              <table border="1" width="680"  class="table table-bordered table-striped table-hover" style="font-size:10px;">
				...
				%>
                <tr>
                  <td width="300"><a class="link_uni" href="detalle_uni.jsp?uni=<%=uni%>&amp;juris=<%=juris%>&tipo=<%=request.getParameter("tipo")%>"><%=uni%></a></td>
