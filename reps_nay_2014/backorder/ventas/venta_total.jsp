...
<div class="row">
	<div>
   	<a href="../../reportes_nay/index_main.jsp">Regresar</a></div>
</div>
	<div class="row">
    	<div class="span6">
        <h2>Ventas Totales&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gnr_venta_total.jsp"><img src="../../imagen/Excel-2013.png" alt="Exportar a Excel" width="40" height="40" /></a></h2>
		<div>
...
$(function () {
    ...
    $('#grafico').highcharts({
        ...
        series: [{
            ...
            name: 'Porcentaje',
            data: [
                ['Total Farmacias',   <%=surf%>],
                ['Total Almacenes',  <%=sura%>],
				['Total Primer Nivel',  <%=sur1%>],
				['Total Programas',  <%=surp%>],
				['Total Pedidos Extraordinarios',  <%=surpe%>],
                ['Total Controlados', <%=surc%>]
            ]
        }]
    });
});
