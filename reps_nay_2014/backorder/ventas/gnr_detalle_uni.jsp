...
response.setHeader ("Content-Disposition", "attachment;filename=\"BackOrder_Unidad_"+request.getParameter("uni")+"_"+tip+".xls\"");
%>
    <div> Reporte de Ventas &gt; Tipo <%=tip%> &gt; Jurisdiccion <%=juris%> &gt; <%=request.getParameter("uni")%></div>
  </div>
  <div>
