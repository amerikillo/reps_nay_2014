...
response.setHeader ("Content-Disposition", "attachment;filename=\"BackOrder_Municipio_"+request.getParameter("mun")+"_"+tip+".xls\"");
%>
    <div> Reporte de Ventas &gt; Tipo <%=tip%> &gt; Jurisdiccion <%=juris%> &gt; <%=request.getParameter("mun")%></div>
  </div>
  <div>
