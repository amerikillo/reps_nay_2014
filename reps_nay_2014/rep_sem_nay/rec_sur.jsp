...
<div style="width:600; float:right; background-color:#FFF; padding:15px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">
  <div class="tit_tablas">
    ...
    al: <input name="fecha2" type="text" id = "fecha2" value="<%=f2_mos%>" size="10" readonly /><img src="../imagen/cal.gif" width="15" height="15" border="0" onClick="scwShow(scwID('fecha2'),event);"/>
     ...
     <a href="recetas_surtidas/gnr_rec_sur.jsp?fecha1=<%=f1_mos%>&fecha2=<%=f2_mos%>&Submit=Filtrar"><img src="../imagen/exc.jpg" width="69" height="50" alt="Exportar a Excel" /></a>
    </form>
    </div>
 <br /><br />
    <div class="tit_tablas">
    	...
    	<tr>
            ...
            <td>
                 <table border="1" bgcolor="#F2F2F2" bordercolor="#FFFFFF" cellspacing="0">
                    ...
                    <%
                    String qry_pzsol="select sum(can_sol) as sol, bi.fec_carga from receta r, detreceta dr, usuarios us, unidades un, bitacora bi where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by DAY(fec_carga) ;";
            //String qry_pzsol="select sum(can_sol) as sol, fec_sur from detreceta where fec_sur BETWEEN '"+fecha1+"' AND '"+fecha2+"' group by fec_sur";
                    ...
                    %>
                    <%
                    String qry_pzsur="select sum(can_sol) as sol, sum(cant_sur) as sur, bi.fec_carga from receta r, detreceta dr, bitacora bi, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by DAY(fec_carga) ;";
                    %>
                    <tr>
                    <%
                    ...
                    String qry_cant_pzsf="select dp.cla_pro from receta r, detreceta dr, bitacora bi, detalle_productos dp, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND dr.det_pro = dp.det_pro and bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by dp.cla_pro ;";
                    ...
                    String qry_cant_pzsnf="select dp.cla_pro from receta r, detreceta dr, bitacora bi, detalle_productos dp, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and dr.status=0 and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND dr.det_pro = dp.det_pro and bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by dp.cla_pro ;";
                    ...
                    while(rset.next()){
                        fecha=rset.getString("fec_sur"); 
                        int tot_folios=0;
                        String qry_pzsur_col="select r.id_rec from bitacora bi, receta r, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and bi.fec_carga between '"+fecha+" 00:00:01' and '"+fecha+" 23:59:59' and r.baja = '0' and r.id_rec = bi.id_rec group by id_rec";
                    ...
                    while(rset.next())
                    {
                        ...
                        String qry_surno="select r.id_rec from bitacora bi, receta r, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and bi.fec_carga between '"+fecha+" 00:00:01' and '"+fecha+" 23:59:59' and r.baja = '0' and r.id_rec = bi.id_rec group by id_rec";
                    ...
                    %>
                    <%
                    String qry_por="select sum(can_sol) as sol, sum(cant_sur) as sur, bi.fec_carga from receta r, detreceta dr, bitacora bi, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by DAY(fec_carga) ;";
                    %>
                    <tr>
                    <%
                    int c_dias=0;
                    ...
                    <%
                    int tot_pzs_sol=0;
                    String qry_fecha1="select sum(cant_sur) as sur, bi.fec_carga from receta r, detreceta dr, bitacora bi, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and r.id_rec = dr.id_rec and  r.id_rec = bi.id_rec AND bi.fec_carga BETWEEN '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by DAY(fec_carga) ;";
                    ...
                    <%
                    float tot_ventas=0;
                    String qry_fecha2="SELECT p.cos_pro, dr.cant_sur, sum(p.cos_pro * dr.cant_sur) as sum FROM detreceta dr, detalle_productos dp, productos p, receta r, bitacora bi, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and dr.id_rec = r.id_rec and r.id_rec = bi.id_rec and dr.det_pro = dp.det_pro AND dp.cla_pro = p.cla_pro and bi.fec_carga between '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' group by DAY(bi.fec_carga) asc;";
