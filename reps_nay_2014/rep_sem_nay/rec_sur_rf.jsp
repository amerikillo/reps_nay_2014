...
<div style="width:600; float:right; background-color:#FFF; padding:15px; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif">
  <div class="tit_tablas">
    ...
    al: <input name="fecha2" type="text" id = "fecha2" value="<%=f2_mos%>" size="10" readonly /><img src="../imagen/cal.gif" width="15" height="15" border="0" onClick="scwShow(scwID('fecha2'),event);"/>
     ...
     <a href="recetas_surtidas/gnr_rec_sur_rf.jsp?fecha1=<%=f1_mos%>&fecha2=<%=f2_mos%>&Submit=Filtrar"><img src="../imagen/exc.jpg" width="69" height="50" alt="Exportar a Excel" /></a>
    </form>
    </div>
 <br /><br />
    <div class="tit_tablas">
    	...
    	<tr>
            ...
            //String qry_pzsol="select sum(can_sol) as sol, fec_sur from detreceta where fec_sur BETWEEN '"+fecha1+"' AND '"+fecha2+"' and  group by fec_sur";
                    ...
                    while(rset.next()){
                        fecha=rset.getString("fec_sur"); 
                        int tot_folios=0;
                        String qry_pzsur_col="select r.id_rec from bitacora bi, receta r, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and bi.fec_carga between '"+fecha+" 00:00:01' and '"+fecha+" 23:59:59' and r.baja = '0' and r.id_rec = bi.id_rec and r.id_tip='1' group by id_rec";
                    ...
                    while(rset.next())
                    {
                        ...
                        String qry_surno="select r.id_rec from bitacora bi, receta r, usuarios us, unidades un where us.cla_uni = un.cla_uni and us.id_usu = r.id_usu and un.des_uni = '"+unidad+"' and bi.fec_carga between '"+fecha+" 00:00:01' and '"+fecha+" 23:59:59' and r.baja = '0' and r.id_rec = bi.id_rec and r.id_tip='1' group by id_rec";
