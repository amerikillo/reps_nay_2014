	...
	function build() {
		...
		svg.Element.svg = function(node) {
			...
			this.setContext = function(ctx) {
				...
				if (typeof(this.receta_usr) == 'undefined' && this.attribute('width').hasValue() && this.attribute('height').hasValue()) {
		...
		svg.Element.GradientBase = function(node) {
			...
			this.createGradient = function(ctx, element) {
				...
				if (this.attribute('gradientTransform').hasValue()) {
					...
					var receta_usrView = svg.ViewPort.viewPorts[0];
					...
					tempSvg.attributes['width'] = new svg.Property('width', receta_usrView.width);
					tempSvg.attributes['height'] = new svg.Property('height', receta_usrView.height);
					tempSvg.children = [ group ];
					
					var c = document.createElement('canvas');
					c.width = receta_usrView.width;
					c.height = receta_usrView.height;
