...
//
//            Your receta_usr directory of the web site should also contain an empty
...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwInvalidAlert        = ['Fecha Inválida (',') ignored.'];
             scwDateDisablingError  = ['Error ',' obejto Date Inválido.'];
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #CDE6B5;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #990000;'   +
                                        'color:             #FFFFFF;}'  +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #F4FFE4;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            ...
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #FF8C8C;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #FF8C8C;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot:hover,'                                         +
            'td.scwFootHover            {color:             #990000;'   +
                                        'cursor:            pointer;'   +
                                        'font-weight:       bold;}'     +
            '/* Disabled cells */'                                      +
            '/* Week Day */'                                            +
...
alert("BIENVENIDOS AL SISTEMA DE REPORTES WEB"+"\n\n"+"SISTEMA EN PERIODO DE PRUEBAS"+"\n"+"EL PERIDO INICIAL ES DEL 10/03/2009 AL 28/07/2009"+"\n"+"LOS DATOS SE ACTUALIZARAN CADA 72 HRS");	
}