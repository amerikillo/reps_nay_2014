...
int total_surtido=0, total_solicitado=0, tot_rec=0, tot_rec_f=0, tot_rec_c=0, cont_mun=0;
float niv_serv=0;
...
rset=stmt.executeQuery("select sum(can_sol),sum(cant_sur) from total_receta where fec_carga between '"+fecha1+"' and '"+fecha2+"' and des_jur = '"+request.getParameter("id_cs")+"' ;");
while(rset.next()){
	total_solicitado=Integer.parseInt(rset.getString(1));
	total_surtido=Integer.parseInt(rset.getString(2));
}

rset=stmt.executeQuery("select id_rec from total_receta where des_jur = '"+request.getParameter("id_cs")+"' and fec_carga between '"+fecha1+"' and '"+fecha2+"' group by id_rec;");
while(rset.next()){
	tot_rec++;
}

rset=stmt.executeQuery("select id_rec from total_receta where id_tip = '1' and des_jur = '"+request.getParameter("id_cs")+"' group by id_rec;");
while(rset.next()){
	tot_rec_f++;
}

rset=stmt.executeQuery("select id_rec from total_receta where id_tip = '2' and des_jur = '"+request.getParameter("id_cs")+"' group by id_rec;");
while(rset.next()){
	tot_rec_c++;
}

try{
	niv_serv = (total_surtido*100)/total_solicitado;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="155" height="370" valign="top" bgcolor="#FFFFFF"><table border="0" cellspacing="0" cellpadding="0" width="175" id="navigation">
        <tr>
          <td width="174" height="40" bordercolor="#000000" bgcolor="#FFFFFF"><a href="receta_elec.jsp" class="style4 style4">Regresar a Menú</a></td>
        </tr>
        <tr>
    ...
    <td colspan="3" valign="top"><img src="mm_spacer.gif" alt="" width="304" height="1" border="0" /><br />
      <table border="1" cellspacing="0" cellpadding="0" width="690">
        ...
        <tr>
          <td width="428" bgcolor="#FFFFFF" class="bodyText style4">Recetas Elaboradas: </td>
          <td width="95" bgcolor="#FFFFFF" class="bodyText"><span class="style4"><strong>&nbsp;<span class="bodyText style4"><%=format.format(tot_rec)%></span></strong></span></td>
          <td bgcolor="#FFFFFF" class="bodyText">&nbsp;</td>
        </tr>
        <tr>
          <td width="428" bgcolor="#FFFFFF" class="bodyText style4">Piezas Solicitadas: </td>
          <td width="95" bgcolor="#FFFFFF" class="bodyText"><span class="style4"><strong>&nbsp;<span class="bodyText style4"><%=format.format(total_solicitado)%></span></strong></span></td>
          <td bgcolor="#FFFFFF" class="bodyText">&nbsp;</td>
        </tr>
        <tr>
          <td width="428" bgcolor="#FFFFFF" class="bodyText style4"> Piezas Surtidas: </td>
          <td width="95" bgcolor="#FFFFFF" class="bodyText"><span class="style4"><strong>&nbsp;<span class="bodyText style4"><%=format.format(total_surtido)%></span></strong></span></td>
          <td bgcolor="#FFFFFF" class="bodyText">&nbsp;</td>
        </tr>
        <tr>
          <td width="428" bgcolor="#FFFFFF" class="bodyText style4">Nivel de Servicio: </td>
          <td width="95" bgcolor="#FFFFFF" class="bodyText"><span class="style4"><strong>&nbsp;<span class="bodyText style4"><%=format.format(niv_serv)%>%</span></strong></span></td>
        ...
        <tr>
          <td bgcolor="#FFFFFF" class="bodyText" colspan="3"><span class="style4"><strong>Rango de fechas</strong></span>:
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <label> <span class="style4">al&nbsp;</span>&nbsp;
              <input name="txtf_caduci" type="text" id="txtf_caduci" size="10" readonly title="dd/mm/aaaa" value="<%=df2.format(df3.parse(fecha2))%>">
            </label>
        ...
        <tr>
          <td colspan="3" bgcolor="#FFFFFF" class="bodyText style4"><!------------------------------------------------------------------------------------>
            ...
            <table width="690" border="0" bgcolor="#EEEEEE" cellpadding="3">
              <tr>
                <td width="360">&nbsp;</td>
                <td width="78" class="tit_tablas">Recetas</td>
                <td width="60" class="tit_tablas">Pzs Surtidas</td>
		...
		while(rset.next()){
			...
			String qry_rec_mun= "select id_rec from total_receta where des_mun = '"+muni+"' and fec_carga between '"+fecha1+"' and '"+fecha2+"' group by id_rec;";
			rset2 = stmt2.executeQuery(qry_rec_mun);
			while(rset2.next()){
				con_rec_mun++;
			}
			...
			%>
              <tr class="mun_uni">
				...
				while(rset2.next()){
					...
					String qry_rec_uni= "select id_rec from total_receta where des_uni = '"+uni+"' and fec_carga between '"+fecha1+"' and '"+fecha2+"' group by id_rec;";
					rset3 = stmt3.executeQuery(qry_rec_uni);
					while(rset3.next()){
						con_rec_uni++;
					}
				%>
                      <tr>
                        <td width="300"><a class="link_uni" href="atla3.jsp?uni=<%=uni%>&juris=<%=request.getParameter("id_cs")%>"><%=uni%></a></td>
                        <td width="70" class="numeros"><%=forma.format(con_rec_uni)%></td>
        ...
        <tr>
          <td colspan="3" bgcolor="#FFFFFF" class="bodyText"><div align="center" class="style3"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
            </span></td>
        </tr>
      </table></td>
    <td width="245" valign="top" bgcolor="#FFFFFF"><img src="mm_spacer.gif" alt="" width="1" height="10" border="0" /><br />
      <table border="0" cellspacing="0" cellpadding="0" width="200">
        ...
        <tr>
          ...
          <td width="110" id="sidebar" class="smallText"><p><img src="../../../imagen/savi1.jpg" alt="SAVI"  border="0" vspace="6" /><br />
