              ...
              <td height="127" colspan="2"><table width="600" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr bgcolor="#FFFFFF" height="17">
                    <td height="17" valign="top"><table width="588" border="1" cellpadding="0" cellspacing="0">
                        ...
                        <%
						try{
							rset=stmt.executeQuery("select cla_pro, des_pro, sum(cant_sur) as sur, sum(cos) as cos from total_dispensado where des_mun = '"+request.getParameter("mun")+"' and fec_carga between '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' and tip_pro = 'MEDICAMENTO' group by cla_pro;");
							while(rset.next()){
						%>
                        <tr height="17">
