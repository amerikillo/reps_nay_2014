...
rset=stmt.executeQuery("select sum(cant_sur) as sur from total_receta WHERE ID_TIP='1' AND  SEXO = 'M' AND fec_carga between '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' GROUP BY fol_rec ORDER BY sur desc limit 0,20;");
while(rset.next()){
  ...
  <table width="1015" border="1" cellpadding="2" bordercolor="#7D2322" class="ver">
    <tr>
      <td width="585"><table width="1005" border="1" cellpadding="0">
          <tr height="17">
            <td height="26" colspan="7" background="../../../imagen/fon3.jpg" bgcolor="#F0F0F0"><div align="center"><a href="#ancla1" class="style8">PRINCIPALES MEDICAMENTOS SEXO MASCULINO </a></div></td>
          </tr>
          <tr height="17">
          ...
          <tr height="17">
		   ...
		   int cont=1;
				...
				try{
							rset=stmt.executeQuery("select cla_pro, des_pro, sum(cant_sur) as sur from total_receta WHERE ID_TIP='1' AND  SEXO = 'M' AND  fec_carga between '"+fecha1+" 00:00:01' and '"+fecha2+" 23:59:59' GROUP BY fol_rec ORDER BY sur desc limit 0,20;");
							while(rset.next()){
