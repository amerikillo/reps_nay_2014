...
<form name="form" action="diagttisem1.jsp" method="post">
...
<table width="1015" border="1" cellpadding="2" bordercolor="#7D2322" class="ver">
		...
		String fechaa2_jv="";
                  ...
                  <span class="style12"><%=!(fecha_1.equals(""))?"Rango desde "+fechaa1_jv+" hasta "+fechaa2_jv:""%></span></td>
                         ...
                         <tr height="17">
                           <td width="35" bgcolor="#CCCCCC" class="dis2" align="center">N&deg;</td>
                           <td width="54" height="23" bgcolor="#CCCCCC" class="dis2"><div align="center">CIE-10</div></td>
                           <td width="599" height="23" bgcolor="#CCCCCC" class="dis2"><div align="center">DESCRIPCION</div></td>
                         ...
                         <%
				 rset_200 = stmt_200.executeQuery("select cldia1,sum(diag1),sum(cant_costo) from t_diag_princ group by cedis;");
if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_200 = stmt_200.executeQuery("select cldia1,sum(diag1),sum(cant_costo) from t_diag_princ where fecha between '"+fecha_1+"' and '"+fecha_2+"' group by cedis;");
...
rset_med = stmt_2000.executeQuery("select cldia1,sum(cant_costo),sum(diag1) from t_diag_princ where cldia1='"+cldia_jv+"' group by cedis ;");
	...
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				...
				//cierra del while
                         ...
                         <tr height="17">
                           <td  width="35" align="center"><%=contdiag%></td>
                           <td height="17" align="right" width="54"><div align="center"><%=("-")%><%//=rset_20.getString("cldia1")%></div>
                           <div align="center"></div></td>
                           <td width="599"><div align="left"><%=("-")%><%//=rset_20.getString("dia1")%></div></td>
