...
<a href="../nayarit_disp/infor.jsp" >Regresar a Men&uacute; </a>
<form action="receta_elec.jsp" method="post" name="form">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="550"><table border="1" cellspacing="0" cellpadding="0" width="990">
              ...
              <tr>
                ...
                <td colspan="7" rowspan="12" class="ver" align="center"><img src="../../../imagen/icono_excel.gif" border="0" usemap="#Map2"/>
                  <input name="Submit2" type="submit" class="smallText" value="<<Valores Iniciales>>" />
                  &nbsp;&nbsp;&nbsp;&nbsp;<a href="consultas.html">REALIZAR CONSULTAS</a>
                  <p> Periodo del &nbsp;&nbsp;&nbsp;&nbsp;<%=df2.format(df3.parse(fecha1))%>&nbsp;&nbsp;&nbsp;&nbsp;al&nbsp;&nbsp;&nbsp;&nbsp;<%=df2.format(df3.parse(fecha2))%></p></td>
              </tr>
              <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><table border="0" cellspacing="0" cellpadding="0" width="764">
        <tr>
          <td width="16">&nbsp;</td>
          <td width="16">&nbsp;</td>
          <td width="16">&nbsp;</td>
          <td width="426" align="center"><img src="../../../imagen/nay_ima1.jpg" width="244" height="75" /></td>
        </tr>
      </table></td>
    <td>&nbsp;</td>
  </tr>
...
<map name="Map2" id="Map2">
  <area shape="rect" coords="5,5,32,31" href="gnr_receta_elec.jsp?txtf_caduc=<%=request.getParameter("txtf_caduc")%>&txtf_caduci=<%=request.getParameter("txtf_caduci")%>" />
</map>
</body>
</html>
</form>
