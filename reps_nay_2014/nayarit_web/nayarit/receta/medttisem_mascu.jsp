...
rset_sex = stmt_sex.executeQuery("select sum(cant_costo),sum(cant_sol),sum(cant_sur) from consolidado where cldia1='"+med_jv+"' and sexo='masculino';");

	  
rset_sexf = stmt_sexf.executeQuery("select folio from consolidado group by folio;");
...
<form name="form" action="medttisem_mascu.jsp" method="post">
<table width="115" border="0">
  <tr>
    <td><a href="diagttmasisem.jsp">Regresar</a></td>
  </tr>
</table>
            ...
            <tr bgcolor="#FFFFFF" height="17">
              <td height="17" valign="top"><table width="801" border="1" cellpadding="2" bordercolor="#932321">
                    ...
                    <td><table width="792" border="1" cellpadding="0" cellspacing="0" class="ver">
                      ...
                      <tr height="17">
                        <td height="26" colspan="7" background="../../../imagen/fon3.jpg"><div align="center" >
                            <div align="center"><a href="#ancla1" class="style8">TOTAL MEDICAMENTO POR DIAGNÓSTICO SEXO MASCULINO </a></div>
                        </div></td>
                      </tr>
                      <tr height="17">
                        <td width="80" height="17" bgcolor="#CCCCCC" class="dis2"><div align="center">CLAVE</div></td>
                        <td width="400" bgcolor="#CCCCCC" class="dis2"><div align="center">DESCRIPCION</div></td>
                        <td width="104" bgcolor="#CCCCCC" class="dis2"><div align="center"><span class="style3">CANTIDAD SOLICITADA </span></div></td>
                        <td width="95" bgcolor="#CCCCCC" class="dis2"><div align="center">CANTIDAD SURTIDA </div></td>
                        <!--td width="101" bgcolor="#CCCCCC" class="dis2"><div align="center">COSTO</div></td-->
                      </tr>
                      <%				  				  
				  ResultSet rset_2 = rset_2 = stmt_2.executeQuery("select med,cldia1,descr,sum(cant_sol) as sol,sum(cant_sur),sum(cant_costo) from consolidado where cldia1='"+med_jv+"' and sexo='masculino' group by med order by  sol desc;");
				  ...
				  if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_fol = stmt_2.executeQuery("select med,descr,sum(cant_sol),sum(cant_sur),sum(cant_costo) from consolidado where cldia1='"+med_jv+"' and sexo='masculino' group by med order by  med desc;");
				  }
				  /* while (rset_fol.next()) 
                  {//out.print("hola");
