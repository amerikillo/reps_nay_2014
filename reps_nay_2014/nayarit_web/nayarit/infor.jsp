...
try { 
 ...
 rset_200 = stmt_min_max.executeQuery("SELECT YEAR(min(fec_sur)) AS anio1,MONTH(Min(fec_sur)) AS mes1 ,DAY(Min(fec_sur)) AS dia1,YEAR(MAX(fec_sur)) AS anio2,MONTH(MAX(fec_sur)) AS mes2 ,DAY(MAX(fec_sur)) AS dia2 FROM registro_surtido;");
	  ...
	  int totax=0;
			...
			if(but.equals("null"))
			  {
				  rset_20 = stmt_20.executeQuery("select sum(total_sur) from juris_mpio where cla_uni != '1002' and cla_uni != '1004' and cla_uni != '1008' and cla_uni != '1014' and cla_uni != '2002' and cla_uni != '2004' and cla_uni != '2006' and cla_uni != '2008' and cla_uni != '3002' and cla_uni != '3004' and cla_uni != '3006' and cla_uni != '3008' and cla_uni != '3010'; ");
...
var d=new Date();
var monthname=new Array("Enero","Febrero","Marxo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
        ...
        <td width="489"><table border="1" cellspacing="0" cellpadding="0" width="507">
            <tr>
              <td height="47" colspan="2" class="pageName style1"><div align="center">
                <p><span class="ROJO">PIEZAS ENTREGADAS A ALMACENES Y PRIMER NIVEL</span><span class="ROJO"> <br />
                ENERO 2014</span>.</p>
              </div></td>
            </tr>
            <tr>
		...
		String fechaa2_jv="";
						...
						rset_day = stmt_day.executeQuery("SELECT DATE_FORMAT('"+fecha_2+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%d/%m/%Y')
		      	           while(rset_day.next())
							   ...
							   %>
                <%=!(fecha_1.equals(""))?"Rango desde "+fechaa1_jv+" hasta "+fechaa2_jv:"Período del 03/08/2012 al 11/03/2013"%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="unidadxclave.jsp?txtf_caduc=<%=fechaa1_jv%>&txtf_caduci=<%=fechaa2_jv%>">Clave x Unidad</a></tr>
            <tr>
            ...
            <%  
		 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio_fecha TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.cla_uni != '3010';");
				  }
				else  
				  rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=1  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.cla_uni != '3010';");
		 ...
		 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio_fecha TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=2 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.	cla_uni != '3010'; ");
				  }
				  else
				  rset_2 = rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=2  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.	cla_uni != '3010';");
			try {
				  while (rset_2.next()) 
                  {
				   ixt_cad=rset_2.getString("sum(total_sur)");
            ...
            <% } } catch (Exception e) {}
		if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio_fecha TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=3 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.	cla_uni != '3010';");
				  }else 
		rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio TOT inner join jurisdicciones JUR on jur.cla_jur=TOT.cla_jur where JUR.cla_jur=3  and TOT.cla_uni != '1002' and TOT.cla_uni != '1004' and TOT.cla_uni != '1008' and TOT.cla_uni != '1014' and TOT.cla_uni != '2002' and TOT.cla_uni != '2004' and TOT.cla_uni != '2006' and TOT.cla_uni != '2008' and TOT.cla_uni != '3002' and TOT.cla_uni != '3004' and TOT.cla_uni != '3006' and TOT.cla_uni != '3008' and TOT.	cla_uni != '3010';");
