...
out.print("local");
   /*parametros para la conexion*/
    ...
    url = "jdbc:mysql://162.209.67.250:3306/receta_electronica";
    usuario = "";
    pass = "";
/*procedimiento de la conexion*/
    try{
...
out.print("durango");
   /*parametros para la conexion*/
    driver = "com.mysql.jdbc.Driver";
   url = "jdbc:mysql://189.197.187.15:3306/receta_electronica";
    usuario = "receta_usr";
    pass = "M8KbqNjTD2";
/*procedimiento de la conexion*/
    try{
...
out.print("nube");
   /*parametros para la conexion*/
    driver = "com.mysql.jdbc.Driver";
    url = "jdbc:mysql://166.78.128.202:3306/receta_electronica";
    usuario = "receta_usr";
    pass = "M8KbqNjTD2";
/*procedimiento de la conexion*/
    try{
