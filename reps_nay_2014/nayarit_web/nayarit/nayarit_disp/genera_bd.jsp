...
String juris5_jv="",fecha5_jv="",uni5_jv="",costo5_jv="",cedis5_jv="",mpio5_jv="",clave5_jv="",descri5_jv="",idm5_jv="",slt_jv="",select_jv="";
String but="r";
...
<title>LLENADO DE DATOS CEAPS y HOSP</title>
<style type="text/css">
<!--
...
<form name="form" action="genera_bd.jsp" method="post">
...
<table width="1015" border="1" cellpadding="2" bordercolor="#7D2322" class="ver">
                     <tr>
                       <td width="585"><table width="1005" border="1" cellpadding="0">
                         ...
                         <tr height="17">
                           <td height="26" colspan="6" background="../../../imagen/fon3.jpg" bgcolor="#F0F0F0"><div align="center"><a href="#ancla1" class="style12">LLENADO DE INFORMACI&Oacute;N A LAS TABLAS</a></div></td>
                         </tr>
                         <tr height="17">
		...
		String fechaa2_jv="";
						...
						rset_day = stmt_day.executeQuery("SELECT DATE_FORMAT('"+fecha_2+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%d/%m/%Y')
                         ...
                         <tr height="17">
                           <td height="26" colspan="4" background="../../../imagen/fon3.jpg" bgcolor="#F0F0F0"><span class="style12">Periodo del:</span> <span class="style12"><%=fecha_11%></span>&nbsp;&nbsp;<span class="style12">al</span>&nbsp;<span class="style12">&nbsp;<%=fecha_22%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>SELECCIONO:&nbsp;&nbsp;<%=select_jv%></strong></span></td>
                         </tr>
                         <tr height="17">
			...
			while(rset_203.next())
			{
				...
				stmt_20.execute("insert into m_"+mpio1_jv+" values('"+juris5_jv+"','"+mpio5_jv+"','"+idm5_jv+"','-','"+fecha5_jv+"','"+clave5_jv+"','"+descri5_jv+"','"+uni5_jv+"','"+costo5_jv+"','"+cedis5_jv+"','-') ;"); //QUERY PARA LLENAR LAS TABLAS POR MUNICIPIO
			...
			while(rset_201.next())
			{
				...
				if (juris2_jv.equals("J.S.1. ATLACOMULCO"))
				{
				stmt_20.execute("insert into j1 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J1
				}
				if (juris2_jv.equals("J.S.2. IXTLAHUACA"))
				{
				stmt_20.execute("insert into j2 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J2
				}
				if (juris2_jv.equals("J.S.3. JILOTEPEC"))
				{
				stmt_20.execute("insert into j3 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J3
				}
				if (juris2_jv.equals("J.S.4. TENANGO DEL VALLE"))
				{
				stmt_20.execute("insert into j4 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J4
				}
				if (juris2_jv.equals("J.S.5. TOLUCA"))
				{
				stmt_20.execute("insert into j5 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J5
				}
				if (juris2_jv.equals("J.S.6. XONACATLAN"))
				{
				stmt_20.execute("insert into j6 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J6
				}
				if (juris2_jv.equals("J.S.7. TEJUPILCO"))
				{
				stmt_20.execute("insert into j7 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J7
				}
				if (juris2_jv.equals("J.S.8. TENANCINGO"))
				{
				stmt_20.execute("insert into j8 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J8
				}
				if (juris2_jv.equals("J.S.9. VALLE DE BRAVO"))
				{
				stmt_20.execute("insert into j9 values('"+juris3_jv+"','"+mpio3_jv+"','"+unidad3_jv+"','"+fecha3_jv+"','"+uni3_jv+"','"+costo3_jv+"','"+cedis3_jv+"','"+cldia3_jv+"') ;"); //QUERY PARA LLENAR LA TABLA J9
				}
			}	
			}
...
stmt_20.execute("insert into u_"+cldia_jv+" values('"+juris_jv+"','"+mpio_jv+"','"+idm_jv+"','"+unidad_jv+"','"+fecha_jv+"','"+clave_jv+"','"+descri_jv+"','"+uni_jv+"','"+costo_jv+"','"+cedis_jv+"','"+cldia_jv+"') ;"); //QUERY PARA LLENAR LAS TABLAS POR UNIDAD

stmt_20.execute("insert into total_juris_all values('"+juris_jv+"','"+mpio_jv+"','"+idm_jv+"','"+unidad_jv+"','"+fecha_jv+"','"+clave_jv+"','"+descri_jv+"','"+uni_jv+"','"+costo_jv+"','"+cedis_jv+"','"+cldia_jv+"') ;"); //QUERY PARA LLENAR LA TABLA TOTAL_JURIS_ALL
			...
			while(rset_202.next())
			{
				...
				stmt_20.execute("insert into total_juris_all_n values('"+juris4_jv+"','"+fecha4_jv+"','"+uni4_jv+"','"+costo4_jv+"','"+cedis4_jv+"') ;"); //QUERY PARA LLENAR LA TABLA total_juris_all_n
