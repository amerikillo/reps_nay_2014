...
<form action="atla2.jsp?mun=<%=request.getParameter("mun")%>&juris=<%=request.getParameter("juris")%>" method="post" name="form">
...
<tr>
  ...
  <td colspan="2" valign="top"><img src="mm_spacer.gif" alt="" width="304" height="1" border="0" /><br />
    <table width="875" border="1" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="41" colspan="3" bgcolor="#FFFFFF"><span class="pez2">JURISDICCIÓN:</span>&nbsp;<%=request.getParameter("juris")%>&nbsp;&nbsp;&nbsp;&nbsp;<span class="pez2"><span class="style7"><a name="ancla2" id="ancla2"></a></span>MUNICIPIO:<%=request.getParameter("mun")%></span>&nbsp;&nbsp;&nbsp;<a href="gnr_municipio.jsp?juris=<%=request.getParameter("juris")%>&txtf_caduc=<%=request.getParameter("txtf_caduc")%>&txtf_caduci=<%=request.getParameter("txtf_caduci")%>&mun=<%=request.getParameter("mun")%>"><img src="../../../imagen/icono_excel.gif" border="0"/></a></td>
      </tr>
      <tr>
