...
ResultSet rset_201 = stmt_201.executeQuery("select min(fec_sur),max(fec_sur),YEAR(min(fec_sur)) AS anio1,MONTH(Min(fec_sur)) AS mes1 ,DAY(Min(fec_sur)) AS dia1,YEAR(MAX(fec_sur)) AS anio2,MONTH(MAX(fec_sur)) AS mes2 ,DAY(MAX(fec_sur)) AS dia2 from juris_mpio_fecha where cla_jur=1;");
				  ...
				  rset_date = stmt_date.executeQuery("SELECT DATE_FORMAT('"+max+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%d/%m/%Y')
  				  ...
  				  ResultSet rset_20 = stmt_20.executeQuery("select sum(total_sur) from juris_mpio where cla_jur=1 and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010');");
...
if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_20 = stmt_20.executeQuery("select sum(total_sur) from juris_mpio_fecha where fec_sur between '"+fecha_1+"' and '"+fecha_2+"' and cla_jur=1 and  cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010')");
				  }
  				  while (rset_20.next()) 
                  {
				  totPzs=rset_20.getString("sum(total_sur)");
...
<table width="1059" border="0" cellpadding="2">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="pageName">PIEZAS ENTREGADAS POR JURISRICCI&Oacute;N</span></div></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
			  ...
			  <%
			 rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=2 and M.cla_jur=1  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun;");
			 
			 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio_fecha TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=2 and M.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun  ;");
				  }
				  while (rset_2.next()) 
                  {
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="607" cellpadding="0" cellspacing="0" border="1">
                ...
                <col width="80" />
				<%
				rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=2  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010')  group by U.cla_uni;");
				
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				 rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio_fecha TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=2 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'   and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
	}
			  ...
			  <%
			 rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=3 and M.cla_jur=1  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun;");
			 
			 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio_fecha TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=3 and M.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun;");
				  }
				  if (rset_2.next()) 
                  {
						ixt_cad=rset_2.getString("sum(total_sur)");
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="607" cellpadding="0" cellspacing="0" border="1">
                ...
                <col width="80" />
				<%
				rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=3  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
				
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				 rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio_fecha TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=3 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
	}
              ...
              <%
			 rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=4 and M.cla_jur=1  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun;");
			 
			 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio_fecha TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=4 and M.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun ;");
				  }
				  while (rset_2.next()) 
                  {
						ixt_cad=rset_2.getString("sum(total_sur)");
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="607" cellpadding="0" cellspacing="0" border="1">
                ...
                <col width="80" />
				<%
				rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=4  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
				
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				 rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio_fecha TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=4 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
	}
...
<%
			 rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=5 and M.cla_jur=1  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun;");
			 
			 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio_fecha TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=5 and M.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun ;");
				  }
				  while (rset_2.next()) 
                  {
						ixt_cad=rset_2.getString("sum(total_sur)");
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="607" cellpadding="0" cellspacing="0" border="1">
                ...
                <col width="80" />
				<%
				rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=5  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
				
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				 rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio_fecha TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=5 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
	}
			  ...
			  <%
			 rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=6 and M.cla_jur=1  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun");
			
			 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,des_mun,sum(total_sur),cla_uni from juris_mpio_fecha TOT inner join municipios M on M.cla_mun=TOT.cla_mun inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where M.cla_mun=6 and M.cla_jur=1 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by M.cla_mun ;");
				  }
				  while (rset_2.next()) 
                  {
						ixt_cad=rset_2.getString("sum(total_sur)");
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="607" cellpadding="0" cellspacing="0" border="1">
                ...
                <col width="80" />
				<%
				rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=6  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by U.cla_uni;");
				
	if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				 rset_200 = stmt_200.executeQuery("select des_jur,des_uni,sum(total_sur),U.cla_uni from juris_mpio_fecha TOT inner join unidades U on U.cla_uni=TOT.cla_uni inner join jurisdicciones J on J.cla_jur=TOT.cla_jur where TOT.cla_mun=6 and fec_sur between '"+fecha_1+"' and '"+fecha_2+"'  and   group by U.cla_uni;");
	}
