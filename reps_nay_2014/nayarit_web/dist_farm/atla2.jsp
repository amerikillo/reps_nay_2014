...
//out.print(mensaje);
  				  ...
  				  ResultSet rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio where cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
				  ...
				  rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MEDICAMENTO' and cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
				  ...
				  rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MATERIAL DE CURACION' and cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
...
if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio_fecha where fec_sur between '"+fecha_1+"' and '"+fecha_2+"' and cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
				  }
  				  while (rset_20.next()) 
                  {
				  totPzs=rset_20.getString("sum(total_sur)");
				  ...
				  if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio_fecha TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MEDICAMENTO'  and fec_sur between '"+fecha_1+"' and '"+fecha_2+"' and cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
				  }
  				  while (rset_20.next()) 
                  {
					totPzsMed=rset_20.getString("sum(total_sur)");
				  ...
				  if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_20 = stmt_20.executeQuery("select sum(total_sur) from total_mpio_fecha TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MATERIAL DE CURACION' and fec_sur between '"+fecha_1+"' and '"+fecha_2+"' and cla_mun='"+mpio_jv+"'  and cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by cla_mun;");
				  }
  				  while(rset_20.next()) 
                	  {
						  cont1++;
            ...
            <tr bgcolor="#FFFFFF" height="17">
              <td height="17" valign="top"><table width="588" border="1" cellpadding="0" cellspacing="0">
                ...
                <tr height="17">
				  ...
				  <%				  				  
				  ResultSet rset_2 = rset_2 = stmt_2.executeQuery("select TOT.cla_pro,P.des_pro as descri,sum(total_sur) from total_mpio TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MEDICAMENTO' and TOT.cla_mun='"+mpio_jv+"'  and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_pro order by tot.cla_pro+0;");
				  if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select TOT.cla_pro,P.des_pro as descri,sum(total_sur) from total_mpio_fecha TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MEDICAMENTO' and TOT.cla_mun='"+mpio_jv+"' and TOT.fec_sur between '"+fecha_1+"' and '"+fecha_2+"'   and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_pro order by tot.cla_pro+0;");
				  }
  				  while (rset_2.next()) 
                  { 
                ...
                <tr height="17">
                  ...
                  <td align="right"><div align="center" class="style3"><%=nf1.format(ixt_uni)%></div>                    <div align="center" class="style6"></div></td>
                  </tr>
				<%
				}
				%>
            ...
            <tr bgcolor="#FFFFFF" height="17">
			  ...
			  <table width="593" border="1" cellpadding="0" cellspacing="0">
                ...
                <tr height="17">
				  ...
				  <%				  
				 rset_2 = stmt_2.executeQuery("select TOT.cla_pro,P.des_pro as descri,sum(total_sur) from total_mpio TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MATERIAL DE CURACION' and TOT.cla_mun='"+mpio_jv+" '   and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_pro order by tot.cla_pro+0;");
				 if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select TOT.cla_pro,P.des_pro as descri,sum(total_sur) from total_mpio_fecha TOT inner join productos P on P.cla_pro=TOT.cla_pro where P.tip_pro='MATERIAL DE CURACION' and TOT.cla_mun='"+mpio_jv+" 'and TOT.fec_sur between '"+fecha_1+"' and '"+fecha_2+"'   and tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_pro  order by tot.cla_pro+0;");
				  }
  				  while (rset_2.next()) 
                  { 
					ixt_cad=rset_2.getString("sum(total_sur)");
