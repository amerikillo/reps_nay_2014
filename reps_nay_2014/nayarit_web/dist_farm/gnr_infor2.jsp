...
rset_20 = stmt_20.executeQuery("select sum(total_sur) from juris_mpio_fecha where cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') ;");
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=593 style='border-collapse:
 ...
 <tr height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  name="DatosExternos_1">Total Medicamento TRANSFERIDO.</a></td>
 </tr>
 ...
 <%				  				  
				  rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio_fecha TOT inner join jurisdicciones  J on J.cla_jur=TOT.cla_jur and  tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_jur;");
				  			  
				  if(!(fecha_1.equals("")) && !(fecha_2.equals(""))){
				  	rset_2 = stmt_2.executeQuery("select des_jur,sum(total_sur) from juris_mpio_fecha TOT inner join jurisdicciones  J on J.cla_jur=TOT.cla_jur where fec_sur between '"+fecha_1+"' and '"+fecha_2+"' and  tot.cla_uni in ('1002', '1004','1008','1014','2002','2004','2006','2008','3002','3004','3006','3008','3010') group by TOT.cla_jur;");
				  }
				  try {
  				  while (rset_2.next()) 
                  { 
 ...
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td class=xl29 x:num style='border-top:none;border-left:none'><%=nf1.format(pz1)%></td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl29 style='border-top:none;border-left:none' x:num><%=nf1.format(totPzs_jv)%></td>
 </tr>
