...
/*parametros para la conexion*/
    ...
    String url = "jdbc:mysql://162.209.67.250:3306/r_nay_disp";
    String usuario = "";
...
out.print("local");
   /*parametros para la conexion*/
    ...
    url = "jdbc:mysql://162.209.67.250:3306/r_nay_disp";
    usuario = "";
    pass = "";
/*procedimiento de la conexion*/
    try{
...
out.print("durango");
   /*parametros para la conexion*/
    driver = "com.mysql.jdbc.Driver";
   url = "jdbc:mysql://189.197.187.15:3306/r_nay_disp";
    usuario = "receta_usr";
    pass = "M8KbqNjTD2";
/*procedimiento de la conexion*/
    try{
...
out.print("nube");
   /*parametros para la conexion*/
    driver = "com.mysql.jdbc.Driver";
    url = "jdbc:mysql://166.78.128.202:3306/r_nay_disp";
    usuario = "receta_usr";
    pass = "M8KbqNjTD2";
/*procedimiento de la conexion*/
    try{
...
<form name="form" action="genera_bd_dispen.jsp" method="post">
...
<table width="1015" border="1" cellpadding="2" bordercolor="#7D2322" class="ver">
                     <tr>
                       <td width="585"><table width="1005" border="1" cellpadding="0">
                         ...
                         <tr height="17">
                           <td height="26" colspan="6" background="../../../imagen/fon3.jpg" bgcolor="#F0F0F0"><div align="center"><a href="#ancla1" class="style12">LLENADO DE INFORMACI&Oacute;N A LAS TABLAS DE ISEM ENTREGAS</a></div></td>
                         </tr>
                         <tr height="17">
		...
		String fechaa2_jv="";
						...
						rset_day = stmt_day.executeQuery("SELECT DATE_FORMAT('"+fecha_2+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%d/%m/%Y')
                         ...
                         <tr height="17">
                           <td height="26" colspan="4" background="../../../imagen/fon3.jpg" bgcolor="#F0F0F0"><span class="style12">Periodo del:</span> <span class="style12"><%=fecha_11%></span>&nbsp;&nbsp;<span class="style12">al</span>&nbsp;<span class="style12">&nbsp;<%=fecha_22%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>SELECCIONO:&nbsp;&nbsp;"<%=select_jv%>"&nbsp;&nbsp;SERVIDOR&nbsp;&nbsp;"<%=server_jv%>"</strong></span></td>
                         </tr>
                         <tr height="17">
			...
			if (slt_jv.equals("2")  ) 
							{
				rset_203 = stmt_2000.executeQuery("select juris,uni_ate,cv_uni,mpio,id_med,fecha,clave,descri,sum(uni) as uni,sum(costo) as costo,cedis from total_juris_all_actualizacion  where fecha between '"+fecha_1+"' and '"+fecha_2+"' and mpio='"+mpio2_jv+"' group by (mpio),clave,fecha;");
			...
			while(rset_203.next())
			{
				...
				String uni_aute5_jv=rset_203.getString("uni_ate");
				...
				String cv_uni5_jv=rset_203.getString("cv_uni");
				
				if ((server.equals("1")) || (server.equals("2")) || (server.equals("3")))
				{
				stmt_20s.execute("insert into m_"+mpio1_jv+" values('"+juris5_jv+"','"+mpio5_jv+"','"+idm5_jv+"','"+uni_aute5_jv+"','"+fecha5_jv+"','"+clave5_jv+"','"+descri5_jv+"','"+uni5_jv+"','"+costo5_jv+"','"+cedis5_jv+"','"+cv_uni5_jv+"') ;"); //QUERY PARA LLENAR LAS TABLAS POR MUNICIPIO
				}
